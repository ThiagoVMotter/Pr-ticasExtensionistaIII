...
if (isset($_GET['msg'])) {
    ...
    if ($_GET['msg'] == 'erro_fk') echo "<div style='padding: 10px; background: #fee2e2; color: #991b1b; margin-bottom: 1rem; border-radius: 4px;'>Erro: Não é possível excluir este cliente pois existem pets vinculados a ele.</div>";
                ...
                <?php foreach ($clientes as $c): ?>
                    <tr style="border-bottom: 1px solid var(--border-color);">
                        ...
                        <td style="padding: 10px;">
                            ...
                            <a href="excluir_cliente.php?id=<?php echo $c['id_cliente']; ?>" class="btn btn-danger" style="padding: 0.3rem 0.6rem; font-size: 0.9rem;" onclick="return confirm('Tem certeza que deseja excluir o cliente <?php echo htmlspecialchars($c['nome']); ?>?');">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
